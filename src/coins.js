...
const coins = [
  ...
  },
  {
    ...
    sell_price: "5",
    buy_price: "7",
    img: "nurettin_coin.png",
    description: "Nurettin coin is a cryptocurrency that is produced by a farmer and business man in Balıkesir,Turkey. Nurettin coin is created in order to increase the trade of the olive oil in the world. Currently, it is used in the Mediterranean countries; however, it will be used around the world soon. Current value of the Nurettin coin is ₺7 but after a year,according to estimations, its value will be a billion turkish liras."
  },
  {
    id: 4,
    name: "Deniz Coin",
